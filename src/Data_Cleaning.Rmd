...
Burnaby and Vancovuer: Less that 10 cases are different form others -> Take mode 
...
write.csv(assessment.aggregate, "../data/Assessment/assessment_aggregate.csv")
write.csv(assessment.pct, "../data/Assessment/assessment_pct.csv")
```{r}
