...
avg_assessment_by_municipality = dat %>% 
  ...
  mutate(avg_assessment = median(total.assessment, na.rm=TRUE)) %>% 
...
plot(yhat.bag1, test_as$next.assess, xlab="Predicted Asssessment Value Using Test Set", ylab="Actual Assessment Value", ylim=c(0, 6e8))
abline(0,1)
```
